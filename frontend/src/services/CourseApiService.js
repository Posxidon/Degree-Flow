const CourseApiService = {
  ...
  getSubjectCodes() {
    ...
    return ['ANTHROP', 'ARABIC', 'ART', 'ARTHIST', 'ARTSSCI', 'ASTRON', 'AUTOTECH',
      ...
      'COLLAB', 'COMMERCE', 'COMPENG', 'COMPSCI', 'DATASCI', 'EARTHSC', 'ECON', 'ELECBME', 'ELECENG', 'ENGINEER',
      ...
      'LATIN', 'LIFESCI', 'LINGUIST', 'MANTECH', 'MATH', 'MATLS', 'MATLSBME', 'MECHBME', 'MECHENG', 'MECHTRON',
